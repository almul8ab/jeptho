...
async def handle_incoming_message(event):
    ...
    if group_game_status[chat_id]['is_game_started2'] and event.sender_id == bot_entity.id and "انا" in event.raw_text.lower() and not group_game_status[chat_id]['joker_player']:
