...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            "قائمة أوامر النشر التلقائي\n"
            "★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n"
            "᯽︙ اختر أحدى هذه الأوامر\n\n"
            "- ( `.نشر + عدد الثواني + معرف المجموعة` ) : يستخدم هذا الأمر لنشر الرسالة مع عدد الثواني المحدد بالرد على الرسالة.\n"
            "- ( `.نشر_كروبات + عدد الثواني` ) : يقوم بنشر التلقائي لجميع المجموعات في حسابك بالرد على الرسالة.\n"
            "- ( `.سوبر + عدد الثواني` ) : يقوم بالنشر فقط في مجموعات السوبر بالرد على الرسالة.\n"
            "- ( `.ايقاف النشر` ) : لإيقاف جميع أنواع النشر المذكورة سابقاً.\n"
            "- ( `.النشر تفعيل|تعطيل` ) : يقوم بمنع نشر التلقائي في المجموعة أو تفعيله (السماح) بالرد على الرسالة\n"
            "||يمكنك الحصول على شرح لإستخدام النشر التلقائي [هنا](https://t.me/JEPTHON/1395)||.\n\n"
            "★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n"
            "⌔︙CH : @jepthon"
        )